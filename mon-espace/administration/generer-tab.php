...
if($_GET['rubrique']=='licence3'){
  ...
  if(isset($_GET['mode'])){
    ...
    if($_GET['mode']=='apprentissage'){
      ...
      $query = "SELECT P.Id_Pers id, P.Nom nom, P.Prenom prenom, E.Mode statut,E.Niveau niveau FROM Etudie E, Personne P where P.Id_Pers = E.Id_Pers
...
while ($personne = $result->fetchArray()) {
    echo "<tr>
           <td><input type='checkbox' data-id='".$personne['id']."' ></td>
           <td>".$personne['nom']."</td>
